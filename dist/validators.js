 ...
 */
export function isAlloowedQuery(query) {
    ...
    const startsWithAllowedNoSpace = normalizedQuery.startsWith("INSERT") && !ALLOW_INSERT;
    ...
    const hasMultipleStatements = normalizedQuery.includes(";") && !normalizedQuery.endsWith(";");
...
export function validateQuery(query) {
    ...
    if (!isAlloowedQuery(query)) {
        ...
        throw new Error("Query contains disallowed commands or is not permitted by current configuration");
    }
